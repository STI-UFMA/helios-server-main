...
ALLOWED_HOSTS = ['ip_do_servidor','nome_dns','localhost','127.0.0.1']

# Make this unique, and don't share it with anybody.
SECRET_KEY = get_from_env('SECRET_KEY', 'chave_secreta_django')
ROOT_URLCONF = 'urls'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': get_from_env('DB_PWD', 'senha_bd_helios'),
...
#)
AUTH_LDAP_SERVER_URI = "ldap://servidor_ldap" # replace by your Ldap URI
AUTH_LDAP_BIND_DN = "cn=admin,dc=dominio,dc=com"
AUTH_LDAP_BIND_PASSWORD = "senha_bind"
AUTH_LDAP_USER_SEARCH = LDAPSearch("ou=usuarios_admin_eleicao,dc=dominio,dc=com",
    ldap.SCOPE_SUBTREE, "(uid=%(user)s)"
)
